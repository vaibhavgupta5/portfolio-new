...
function LeftSideBar() {
  ...
  return (
               <aside className="md:w-[14%] end-0 h-[10vh] fixed md:h-screen md:sticky  border-r-1 flex md:flex-col md:items-center md:justify-center border-[#202021] top-0 bg-gray-100 md:dark:bg-[#050505] dark:bg-[#141415]">
              <div className="flex md:h-[95vh] h-auto w-full pr-8 md:flex-col justify-between items-end p-4">
                <Image
                ...
                <div className="flex gap-4 md:flex-col justify-center items-start ml-4">
                  ...
                  <div className="flex gap-4 group justify-center items-center">
                   ...
                   <div className="flex gap-4 group justify-center items-center">
                    ...
                    />
                    <h1 className="group-hover:text-[#999999] scale-75 bg-transparent text-transparent   group-hover:scale-100  group-hover:right-25 group-hover:flex transition-all ease-in-out duration-500 group-hover:bg-[#141415] p-2 px-3 rounded-xl group-hover:dark:text-white absolute right-15 ">Resume</h1>
                  </div>
                </div>
